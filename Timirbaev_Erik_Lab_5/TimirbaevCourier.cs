    ...
    public class TimirbaevCourier
    {
        ...
        public virtual void CreateCourier()
        {
            while (true)
            {
                ...
                if (string.IsNullOrEmpty(firstname)) Console.WriteLine("Ошибка!");
                else break;
            }
            ...
            while (true)
            {
                ...
                if (string.IsNullOrEmpty(surname)) Console.WriteLine("Ошибка!");
                else break;
            }
            ...
            while (true)
            {
                ...
                if (!TimirbaevUtilities.IsDigitsOnly(phone) || phone.Length != 10) Console.WriteLine("Ошибка!");
                else break;
            }
        }
