...
void TimirbaevPark::AddCourier() {
	TimirbaevCourier courier{"", "", 0, "" };
	shared_ptr<TimirbaevCourier> ptr = make_shared<TimirbaevCourier>(courier);
	ptr->CreateCourier(cin);
	couriers.push_back(ptr);
}

void TimirbaevPark::AddAutoCourier() {
	TimirbaevAutoCourier auto_courier{"", "", 0, "", "", ""};
	shared_ptr<TimirbaevAutoCourier> ptr = make_shared<TimirbaevAutoCourier>(auto_courier);
	ptr->CreateCourier(cin);
	couriers.push_back(ptr);
}
